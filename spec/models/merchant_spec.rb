...
RSpec.describe Merchant, type: :model do
  ...
  describe 'instance variables' do
    ...
    describe '.invoice_items_for_invoice' do
      before(:each) do
        @merchant_1 = create(:merchant)
      ...
      it 'returns a list of items on an invoice belonging to a merchant. includes item name and information from invoice_item' do
        merchant_1_items = @merchant_1.invoice_items_for_invoice(@invoice_1.id)
        ...
        merchant_2_items = @merchant_2.invoice_items_for_invoice(@invoice_1.id)
